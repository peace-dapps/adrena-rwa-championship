      ...
      <div style={{position:'relative',zIndex:1,maxWidth:1100,margin:'0 auto',padding:'0 16px 60px'}}>
        ...
        <div style={{marginTop:16,display:'flex',justifyContent:'space-between',alignItems:'center',flexWrap:'wrap',gap:10}}>
          ...
          <div style={{display:'flex',gap:8,flexWrap:'wrap'}}>
            <button className="rbtn" onClick={()=>router.push('/referral')} style={{border:'1px solid var(--border)',borderRadius:6,color:'var(--text-secondary)',fontFamily:"'Space Mono',monospace",fontSize:'0.75rem',padding:'6px 14px',background:'none',cursor:'pointer'}}>
              Refer Friends
            </button>
            <button className="rbtn" onClick={()=>router.push('/feedback')} style={{border:'1px solid var(--border)',borderRadius:6,color:'var(--text-secondary)',fontFamily:"'Space Mono',monospace",fontSize:'0.75rem',padding:'6px 14px',background:'none',cursor:'pointer'}}>
              Give Feedback
            </button>
